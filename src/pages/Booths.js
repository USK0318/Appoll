  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', padding: '20px' }}>
      <div style={{ marginBottom: '20px' }}>
        ...
        <select style={{marginRight: '18px', padding: '8px', borderRadius: '4px', width: '20%', border: '1px solid #ccc' }}>
      ...
      <table style={{ borderCollapse: 'collapse', width: '80%', marginBottom: '20px', boxShadow: '0 4px 8px rgba(0,0,0,0.1)' }}>
        <thead>
          <tr style={{ backgroundColor: '#f2f2f2' }}>
            ...
            <th style={{ padding: '8px', textAlign: 'left' }}>Booth NO</th>
            <th style={{ padding: '8px', textAlign: 'left' }}>Suchivalyam</th>
        ...
        <tbody>
          <tr>
            ...
            <td style={{ border: '1px solid #ddd', padding: '8px' }}>1</td>
            <td style={{ border: '1px solid #ddd', padding: '8px' }}>Suchivalyam 1</td>
          ...
          <tr>
            ...
            <td style={{ border: '1px solid #ddd', padding: '8px' }}>2</td>
            <td style={{ border: '1px solid #ddd', padding: '8px' }}>Suchivalyam 2</td>
          ...
          <tr>
            ...
            <td style={{ border: '1px solid #ddd', padding: '8px' }}>3</td>
            <td style={{ border: '1px solid #ddd', padding: '8px' }}>Suchivalyam 3</td>
