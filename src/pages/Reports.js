      ...
      <table style={{ borderCollapse: 'collapse', width: '80%', marginBottom: '20px', boxShadow: '0 4px 8px rgba(0,0,0,0.1)' }}>
        <thead>
          <tr style={{ backgroundColor: '#f2f2f2' }}>
            ...
            <th style={{ padding: '8px', textAlign: 'left' }}>Relision</th>
            <th style={{ padding: '8px', textAlign: 'left' }}>Openion</th>
        ...
        <tbody>
          <tr>
            ...
            <td style={{ border: '1px solid #ddd', padding: '8px' }}>Relision 1</td>
            <td style={{ border: '1px solid #ddd', padding: '8px' }}>Openion 1</td>
          </tr>
          <tr>
            ...
            <td style={{ border: '1px solid #ddd', padding: '8px' }}>Relision 2</td>
            <td style={{ border: '1px solid #ddd', padding: '8px' }}>Openion 2</td>
          </tr>
          <tr>
            ...
            <td style={{ border: '1px solid #ddd', padding: '8px' }}>Gender 3</td>
            <td style={{ border: '1px solid #ddd', padding: '8px' }}>Relision 3</td>
            <td style={{ border: '1px solid #ddd', padding: '8px' }}>Openion 3</td>
          </tr>
        </tbody>
      </table>
